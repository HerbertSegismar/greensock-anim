...
export function SignupForm() {
  ...
  return (
    <div className="shadow-input mx-auto mt-20 rounded-lg w-[90vw] md:w-full max-w-md px-8 py-1 mb-2 md:py-12 dark:bg-black/80">
      <h2 className="text-xl font-bold text-neutral-800 mt-4 mb-2 dark:text-amber-300 uppercase text-center">
        Login Form
      </h2>
      <p className="mt-1 max-w-sm text-xs text-neutral-600 dark:text-neutral-300 text-center">
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <LabelInputContainer className="mb-4">
          ...
          <Input id="email" placeholder="youmaysignup@gmail.com" type="email" />
        </LabelInputContainer>
        <LabelInputContainer className="mb-4">
          <Label htmlFor="password">Password</Label>
          <Input id="password" placeholder="••••••••" type="password" />
        </LabelInputContainer>
        <LabelInputContainer className="mb-4 md:mb-8">
        ...
        <div className="my-4 md:my-8 flex items-center before:h-[1px] w-full bg-gradient-to-r from-transparent via-neutral-300 to-transparent dark:via-neutral-700" />
